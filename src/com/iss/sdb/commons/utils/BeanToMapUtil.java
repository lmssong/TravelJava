...
public class BeanToMapUtil {
    ...
    public static Map convertBean(Object bean) {
        ...
        try {
            ...
            logger.error("[BeanToMapUtil.convertBean] IntrospectionException:" + e.getMessage());
        }
        catch (IllegalAccessException e) {
            logger.error("[BeanToMapUtil.convertBean] IllegalAccessException:" + e.getMessage());
        }
        catch (IllegalArgumentException e) {
            logger.error("[BeanToMapUtil.convertBean] IllegalArgumentException:" + e.getMessage());
        }
