...
<div id="container">
  <div class="column">
    ...
    <div style="line-height: 30px;margin: 10px;padding: 15px;margin-top: 20px;border-radius: 6px;box-shadow: 1px 3px 11px 5px #dcd3c0;">
      	<div class="jdinfo" style="width: 1000px;height: 30px;font-size: 18px;font-weight: 600;"><h3>${news.title}</h3></div>
	    <div class="jdinfo" style="width:1000px;color:red">
	      	${news.createTime}
	      </div>
	      <div class="jdinfo" style="width:1000px;    height: auto;text-align: center;">
	      	<img src="${news.image}" />
	      </div>
	      
	      <div class="jdinfo" style="width:1000px;height: auto;">
	    	<strong>摘要</strong>：<span>${news.abstracts}</span>
	    	</div>
	      <div class="jdinfo" style="width:1000px;height: auto;">
